...
$result = mysqli_query($conn, "SELECT DISTINCT id, nip, nama, umur, jenis_kelamin, departemen, jabatan, kota_asal FROM karyawan_absensi");
?>
...
<body class="bg-gray-100 p-8">
  <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-lg">
    ...
    <div class="flex justify-between mb-6">
      <!-- tombol tambah -->
      <a href="tambah.php" class="bg-green-500 hover:bg-green-600 text-white p-2 rounded-full">
        <!-- svg tambah -->
        ...
        <tbody>
          <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <tr class="text-center border-t">
              ...
              <td class="px-4 py-2"><?= htmlspecialchars($row['umur']) ?></td>
              ...
              <td class="px-4 py-2"><?= htmlspecialchars($row['kota_asal']) ?></td>
              <td class="px-4 py-2">
